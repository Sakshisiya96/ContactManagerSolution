...
namespace ContactManager.Infrastructure.Migrations
{
    ...
    [Migration("20250818160804_IdentityTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContactManager.UI.Domain.Entities.Country", b =>
                {
            ...
            modelBuilder.Entity("ContactsManager.Core.Domain.IndentityEntities.ApplicationRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ContactsManager.Core.Domain.IndentityEntities.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Entity.Person", b =>
                {
                    b.HasOne("ContactManager.UI.Domain.Entities.Country", "Country")
                        .WithMany("persons")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("ContactsManager.Core.Domain.IndentityEntities.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("ContactsManager.Core.Domain.IndentityEntities.ApplicationUser", null)
                        .WithMany()
